"""Publish the existing v1.0 tag and verified APK using Git Credential Manager."""
import hashlib
import json
import os
...
TAG = "v1.0"
COMMIT = "f3d588e9c553821ac7f40fbe85de25452aab564a"
NAME = "Video-Companion-v1.0-debug.apk"
APK = ROOT / "app/build/outputs/apk/debug/app-debug.apk"
BODY = (ROOT / "releases/v1.0.md").read_text(encoding="utf-8")
...
try:
    ...
    release = existing or request("releases", "POST", {
        "tag_name": TAG, "target_commitish": COMMIT, "name": "Video Companion v1.0 — Bản phát hành đầu tiên",
